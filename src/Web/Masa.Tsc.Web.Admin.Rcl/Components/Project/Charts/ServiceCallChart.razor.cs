...
public partial class ServiceCallChart
{
    ...
    protected override void OnInitialized()
    {
        ...
        _options.SetValue("tooltip.formatter", "{b}<br /><div style=\"display:flex;align-items: center;\"><div style=\"width:8px;height:8px;background-color:#cb18f8;border-radius:50px;\"></div>&nbsp;&nbsp;<div>(调用次数/每分钟){c}</div></div>");
    }
