...
namespace Masa.Tsc.Web.Admin.Rcl.Components.Dashboards.Configurations.Panel.Trace;
...
public class TraceResponseTree : TraceResponseDto
{
    ...
    public double DoubleDuration => (EndTimestamp - Timestamp).TotalMilliseconds;
}
