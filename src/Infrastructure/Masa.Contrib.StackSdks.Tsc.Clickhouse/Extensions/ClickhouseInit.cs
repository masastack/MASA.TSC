...
namespace Masa.Contrib.StackSdks.Tsc.Clickhouse.Extensions;
...
" };
    ...
    internal static void InitTable(MasaStackClickhouseConnection connection, string tableName, params string[] sqls)
    {
