...
public class LogService : BaseService
{
    ...
    public async Task<PaginationDto<LogDto>> GetPageAsync(LogPageQueryDto param)
    {
        return await Caller.GetAsync<PaginationDto<LogDto>>($"{RootPath}/list", param) ?? default!;
    }
}
